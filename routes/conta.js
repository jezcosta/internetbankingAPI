module.exports = (app) => {
    ...
    app.put('/api/v1/conta/atualizar-favorecido/:id', autenticacao.verificaJWT, conta.atualizarFavorecido);
    app.delete('/api/v1/conta/atualizar-favorecido/:id', autenticacao.verificaJWT, conta.deletarFavorecido);
    app.get('/api/v1/extrato', autenticacao.verificaJWT, conta.getExtrato);
    app.post('/api/v1/extrato', autenticacao.verificaJWT, conta.postExtrato);
